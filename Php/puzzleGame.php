...
// 0 = falso, 1 = verdadeiro, imagem = significa imagem de apoio
    ...
    { 
      if($valor===$niveis[$cont]['nivel']){
      break;
      }
      else if($cont+1 === count($niveis) && $valor!==$niveis[$cont]['nivel'] )
      {
        $pag = "puzzlePage.php";
...
<body>
  ...
  <button style='display:none' type="button" id='resultadoBTN' class="btn btn-primary" data-toggle="modal"
